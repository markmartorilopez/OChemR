...
cfg.DATASETS.TEST = ("my_dataset_test", ) # _test
...
test_metadata = MetadataCatalog.get("my_dataset_test") # _test
...
threshold = 0.95
tested_images = ['/dccstor/arrow_backup/images/test_small/*png']#,'/dccstor/arrow_backup/images/val/*png']# ]
for paths in tested_images:
    for it,imageName in enumerate(glob.glob(paths)): # data/arrow_dt/test/*png
